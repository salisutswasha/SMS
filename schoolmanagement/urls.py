...
urlpatterns = [
    ...
    path('admin-approve-admin', views.admin_approve_admin_view, name='admin-approve-admin'),
    ...
    path('approve-admin-email/<int:pk>/', views.approve_admin_email_view, name='approve-admin-email'),
    path('reject-admin-email/<int:pk>/', views.reject_admin_email_view, name='reject-admin-email'),
